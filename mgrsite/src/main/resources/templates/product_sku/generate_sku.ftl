    ...
    $(function(){
        $("#skuProDiv span").click(function(){
            ...
            if(clazz == "label label-success"){
                ...
                $.ajax({
                    url:"/skuPropertys/"+skuPropertyId+"/skuPropertyValues/table",
                    dataType:"html",
        ...
        $(".generate-sku-btn").click(function () {
            ...
            //定义一个最后需要提交的对象
            var obj = {
                product:{id:"${product.id}",name:"${product.name}",basePrice:"${product.basePrice}",catalog:{id:${product.catalog.id}}},
        ...
        $("#saveButton").click(function () {
            $("#saveSku").ajaxSubmit({
                ...
                success:function (data) {
                    if(data.success){
                        $.messager.popup("保存成功！");
                        $("#content").load("/products/${product.id}/skus")
                    }else{
...
<div class="container-fluid cm-container-white">
    <div class="panel panel-default">
        ...
        <div class="panel-body" >
            ...
            <form action="/skus" id="saveSku" method="post">
            <#--隐藏的商品id-->
            ...
            <div id="skuDiv">
                <table class="table table-bordered sku-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="form-control" name="productSkuList[].code" value="ck12345">
                        </td>
                        <th>
                            黑
                            <input type="hidden" name="productSkuList[].productSkuPropertyList[].skuProperty.id" value="">
                            <input type="hidden" name="productSkuList[].productSkuPropertyList[].value" value="">
                        </th>
                        <th>
                            M
                            <input type="hidden" name="productSkuList[].productSkuPropertyList[].skuProperty.id" value="">
                        ...
                        <td>
                            <input class="form-control price-input" name="productSkuList[].price" value="100">
                        </td>
                        <td>
                            <input class="form-control price-input" name="productSkuList[].stock" value="10000">
                        </td>
                    </tr>
                    </tbody>
                </table>
