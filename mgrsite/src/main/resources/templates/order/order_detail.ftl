            ...
            $("#changeStatusForm").ajaxSubmit({
                success:function (data) {
                    if(data.success){
                        ...
                        $("#content").load("/orders/${orderInfo.id}")
                    }else{
        ...
        <div class="panel-body">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="6">
                            <form id="changeStatusForm" class="form-inline" method="post" action="/orders/${orderInfo.id}">
                        ...
                        <td colspan="6">
                                <#switch orderInfo.status>
                                    ...
                                    <#case "已发货">
                                        ...
                                        <#break>
                                    <#case "已退货">
                                            <button type="button" class="btn btn-primary" data-type="3">订单完成</button>
                                        <#break>
                                    <#case "已完成">
                                            <button type="button" class="btn btn-primary" data-type="4">售后</button>
                                        <#break>
