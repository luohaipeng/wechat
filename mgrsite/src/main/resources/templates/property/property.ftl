...
<script type="text/javascript">
    ...
    //点击分类节点，加载该分类的分类属性（远程载入HTML的形式）
    function clickCatalog(event, treeId, treeNode) {
        $("#propertyList").load("/catalogs/"+treeNode.id+"/propertys");
    }
    ...
    function showPropertyValue(id) {
        ...
        $("#propertyValueForm").load("/propertys/"+id+"/propertyValues")
    }

    //刷新属性列表
    function refreshPropertyList() {
        var nodes = zTreeObj.getSelectedNodes();
        $("#propertyList").load("/catalogs/"+nodes[0].id+"/propertys");
    }
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="/propertys" method="post" id="propertyForm">
